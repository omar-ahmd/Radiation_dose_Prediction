...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', default='DCNN',
                        help='AUTOENC, DCNN, DCNN_2ENC, ENSEMBLE')
    ...
    if not os.path.exists(out_dir):
        raise Exception("Model does not exist, you can train a model under these settings")
    else:
    ...
    if args.model=='AUTOENC':
        model = Model(in_ch=in_ch, out_ch=out_ch,
        ...
        model = Model_sep(in_ch=in_ch, out_ch=out_ch,
        ...
        'Output/DCNN__DFA_ROI_SM_WD/best_val_evaluation_uloss.pkl',
