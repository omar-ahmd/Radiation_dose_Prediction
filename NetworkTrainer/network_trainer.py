...
class NetworkTrainer:
    ...
    def update_average_statistics(self, loss, uloss, phase='train'):
        if phase == 'train':
            ...
            self.log.list_average_train_uloss_associate_iter.append([self.log.average_train_uloss, self.log.iter])
            ...
            self.log.list_average_val_uloss_associate_iter.append([self.log.average_val_uloss, self.log.iter])
    ...
    def run(self):        
        ...
        while (self.log.epoch < self.setting.max_epoch - 1) and (self.log.iter < self.setting.max_iter - 1):
            ...
            self.print_log_to_file(
                ...
                (self.log.average_train_uloss, self.log.best_average_train_uloss), 'a')
            ...
            self.print_log_to_file(
                ...
                % (self.log.average_val_uloss, self.log.best_average_val_uloss), 'a')
